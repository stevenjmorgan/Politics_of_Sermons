...
url = 'https://www.sermoncentral.com/Sermons/Search/?page=10737&sortBy=Newest&keyword=&contributorId=&rewrittenurltype=&searchResultSort=Newest&CheckedScriptureBookId=&minRating=&maxAge=&denominationFreeText='
#browser.get(url)
...
for i in range(0,10960): #10,960 or something crazy big
    ...
    # Locate and store the "Previous" button; click button to navigate to previous page (starts from last search result page)
    try:
        elm = browser.find_element_by_class_name('pagination-previous')
        elm.click()
    except:
        pass
