...
for i in range(11504,0,-1): #range(0,11503)
    ...
    url = 'https://www.sermoncentral.com/Sermons/Search/?page=' + str(i) + '&sortBy=Newest&keyword=&contributorId=&rewrittenurltype=&searchResultSort=Newest&CheckedScriptureBookId=&minRating=&maxAge=&denominationFreeText='
    ...
    for serm in range(0, len(serm_page1)):
        ...
        # Write to .txt files
        counter += 1
        fileName = "Sermon_200000" +  str(counter) + ".txt"
